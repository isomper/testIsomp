...
class LinuxResource(object):
	...
	u'''添加linux资源账号
	   Parameters:
	      ...
	      - cmfpwd:确认口令
	'''
	def add_linux_resource_account(self, editacttname='no', value='no', addactname='no', pwd='no', cmfpwd='no'):
	...
	u'''校验linux资源账号
	   Parameters:
	      ...
	      - cmfpwd:确认口令
	'''
	def check_linux_resource_account(self, value='no', addactname='no', pwd='no', cmfpwd='no'):
